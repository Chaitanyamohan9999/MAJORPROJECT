...
<% 
String year = request.getQueryString();
...
var c=document.form.semister.options[document.form.semister.selectedIndex].value;
window.location="./Subject.jsp?"+c;
...
<td width="172" class="name"><select type="text"  name="semister" onChange="fu()">
